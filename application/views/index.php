                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="py-4">
                                    <span class="peity-line" data-width="100%" data-peity='{ "fill": ["rgba(53, 191, 132, 0.3)"],"stroke": ["rgba(53, 191, 132, 0.8)"]}' data-height="60">4,6,8,7,6,7,9,8,6,5,7,5,8,6,4,8,9,8,5,4</span>
                                </div>
                                <div class="row">
                                    <div class="col-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-center mb-4">
                                    <div class="col-6">
                                        ...
                                        <h4>
                                            <sup class="mr-1"><small>$</small></sup>14,352
                                        </h4>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-center"><span class="peity-pie" data-peity='{ "fill": ["#35bf84", "#f2f2f2"]}' data-width="60" data-height="60">70/100</span></div>
                                    </div>
                                </div>
                                <div>
                    ...
                    <div class="col-xl-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form>
                                    <div class="row">
                                        <div class="col-8 rec-acti-input"><input type="text" name="rec-input-text" class="form-control" placeholder="Add new Activity" /></div>
                                    ...
                                    <table class="table table-hover mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div><img src="assets/images/users/avatar-2.jpg" alt="" class="thumb-sm rounded-circle mr-2" /> Rafael Reardon</div>
                                                </td>
                                                <td>14/10/2018</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div><img src="assets/images/users/avatar-3.jpg" alt="" class="thumb-sm rounded-circle mr-2" /> Thomas Hirsch</div>
                                                </td>
                                                <td>15/10/2018</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div><img src="assets/images/users/avatar-4.jpg" alt="" class="thumb-sm rounded-circle mr-2" /> Archer Desaillly</div>
                                                </td>
                                                <td>15/10/2018</td>
                                                <td><span class="badge badge-success">Delivered</span></td>
                                                <td>$86</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div><img src="assets/images/users/avatar-5.jpg" alt="" class="thumb-sm rounded-circle mr-2" /> Michael Flannery</div>
                                                </td>
                                                <td>16/10/2018</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div><img src="assets/images/users/avatar-6.jpg" alt="" class="thumb-sm rounded-circle mr-2" /> Jamie Fishbourne</div>
                                                </td>
                                                <td>17/10/2018</td>
                                                <td><span class="badge badge-success">Delivered</span></td>
                                                <td>$84</td>
