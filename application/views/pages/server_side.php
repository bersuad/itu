                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped" style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="datatable">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $list['wallet_history_amount'] ?></td>
                                    <td><?php echo date("d-M-y", strtotime($list['wallet_history_created_date'])) ?></td>
                                    <td><?php echo $list['wallet_history_note'] ?></td>
                                    <td><?php echo $list['wallet_histories_recharged_amount_etb'] ?></td>
                                    <td><?php echo date("d-M-y h:m", strtotime($list['wallet_history_signed_date_time']))?></td>
                                    <td>
                                        <button type="button" class="btn btn-outline-primary waves-effect waves-light btn-sm" data-toggle="modal" data-target="#viewWallet<?php echo $list['wallet_history_id'] ?>"><i class="fa fa-eye"></i></button>
                                    </td>
                                </tr>
                                <?php endforeach;?>
                                </tbody>
